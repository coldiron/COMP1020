 ...
 * @version      2019-07-17
 *
 * PURPOSE: Takes orders for a cafe and calculates prices, etc., using a manual
 * linked list rather than an ArrayList.
 */
...
class OrderNode {
    ...
    public OrderNode(Order data, OrderNode next) {
        this.data = data;
        this.next = next;
    }
}
